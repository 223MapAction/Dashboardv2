...
/**
 * Pastille « Gravité … » d'un signalement.
 *
 ...
 * en VERT, la couleur que la carte réserve aux signalements résolus : lu sur une
 ...
 */
export const BadgeGravite = ({ signalement, variante = 'discret', className = '' }) => {
  if (!signalement) return null;

  const niveau = gravite(signalement);
